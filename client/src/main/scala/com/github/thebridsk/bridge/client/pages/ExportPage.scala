...
object ExportPageInternal {
   ...
   *
   */
  case class State( dupids: Option[List[MatchDuplicate.Id]] = None,
              ...
              val s1 = json \ "duplicateIds" match {
                case JsDefined( array: JsArray ) =>
                  Json.fromJson[List[MatchDuplicate.Id]](array) match {
                    ...
                    case JsError(err) =>
                      logger.warning(s"duplicateIds got ${array}, JSON error: ${JsError.toJson(err)}")
              ...
              val s2 = json \ "duplicateResultIds" match {
                case JsDefined( array: JsArray ) =>
                  Json.fromJson[List[MatchDuplicateResult.Id]](array) match {
                    ...
                    case JsError(err) =>
                      logger.warning(s"duplicateResultIds got ${array}, JSON error: ${JsError.toJson(err)}")
              ...
              val s3 = json \ "chicagoIds" match {
                case JsDefined( array: JsArray ) =>
                  Json.fromJson[List[MatchChicago.Id]](array) match {
                    ...
                    case JsError(err) =>
                      logger.warning(s"chicagoIds got ${array}, JSON error: ${JsError.toJson(err)}")
              ...
              val s4 = json \ "rubberIds" match {
                case JsDefined( array: JsArray ) =>
                  Json.fromJson[List[MatchRubber.Id]](array) match {
                    ...
                    case JsError(err) =>
                      logger.warning(s"rubberIds got ${array}, JSON error: ${JsError.toJson(err)}")
