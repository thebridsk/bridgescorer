...
import com.github.thebridsk.bridge.client.pages.individual.router.IndividualDuplicateRouter.DuplicateBoardSetView
import com.github.thebridsk.bridge.client.pages.individual.router.IndividualDuplicateRouter.AllTableView
import com.github.thebridsk.bridge.client.pages.individual.router.IndividualDuplicateRouter.BoardSetSummaryView
...
object DuplicateBridgeAppBar {
  ...
  case class Props(
      id: Option[IndividualDuplicate.Id],
      tableIds: List[Table.Id],
      pageMenuItems: Seq[CtorType.ChildArg],
      title: Seq[CtorType.ChildArg],
      helpurl: String,
      routeCtl: BridgeRouter[IndividualDuplicatePage]
  )
  ...
  protected object Internal {
    ...
    val logger: Logger = Logger("bridge.DuplicateBridgeAppBar")
