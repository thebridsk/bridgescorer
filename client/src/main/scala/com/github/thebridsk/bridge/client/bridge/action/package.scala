...
import _root_.com.github.thebridsk.bridge.data.DuplicatePicture
  ...
  case class ActionStartDuplicateMatch( dupid: MatchDuplicate.Id ) extends DuplicateBridgeAction
  ...
  case class ActionUpdateDuplicateHand( dupid: MatchDuplicate.Id, hand: DuplicateHand) extends DuplicateBridgeAction
  case class ActionUpdateTeam( dupid: MatchDuplicate.Id, team: Team) extends DuplicateBridgeAction
  case class ActionUpdatePicture( dupid: MatchDuplicate.Id, boardid: Board.Id, handid: Team.Id, picture: Option[DuplicatePicture]) extends DuplicateBridgeAction
  case class ActionUpdatePictures( dupid: MatchDuplicate.Id, picture: List[DuplicatePicture]) extends DuplicateBridgeAction
  ...
  case class ActionDeleteChicago( chi: MatchChicago.Id ) extends ChicagoBridgeAction

  case class ActionUpdateChicago( chi: MatchChicago, callback: Option[MatchChicago=>Unit]=None ) extends ChicagoBridgeAction
  case class ActionUpdateChicagoNames( chiid: MatchChicago.Id, nplayer1: String, nplayer2: String, nplayer3: String, nplayer4: String, extra: Option[String], quintet: Boolean, simpleRotation: Boolean, callback: Option[MatchChicago=>Unit]=None ) extends ChicagoBridgeAction
  case class ActionUpdateChicagoRound( chiid: MatchChicago.Id, round: Round, callback: Option[MatchChicago=>Unit]=None ) extends ChicagoBridgeAction
  case class ActionUpdateChicagoHand( chiid: MatchChicago.Id, roundid: Int, handid: Int, hand: Hand, callback: Option[MatchChicago=>Unit]=None ) extends ChicagoBridgeAction
  case class ActionUpdateChicago5( chiid: MatchChicago.Id, extraplayer: String, callback: Option[MatchChicago=>Unit]=None ) extends ChicagoBridgeAction
  ...
  case class ActionUpdateRubberNames( rubid: MatchRubber.Id, north: String, south: String, east: String, west: String, firstDealer: PlayerPosition, callback: Option[MatchRubber=>Unit]=None ) extends RubberBridgeAction
  case class ActionUpdateRubberHand( rubid: MatchRubber.Id, handid: String, hand: RubberHand, callback: Option[MatchRubber=>Unit]=None ) extends RubberBridgeAction
