...
/**
  * Component to show a table card.
  * The table card shows all rounds, the boards that are played in the round,
  * and which teams are NS and EW.
  *
...
object PageTable {
  ...
  /**
    ...
    *
    * @param routerCtl
    * @param page the TableView object that identifies the duplicate match and the table.
