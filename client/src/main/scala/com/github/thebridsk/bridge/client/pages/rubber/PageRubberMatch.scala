...
object PageRubberMatchInternal {
  ...
  class Backend(scope: BackendScope[Props, State]) {
        ...
        case Some(rub) if (rub.id == props.page.rid && rub.gotAllPlayers()) =>
          ...
          <.div(
            ...
            <.div(
              ...
              ViewRubberMatchDetails(
                props.page.toDetails,
                props.routerCtl,
                true
              ),
    ...
    val toDetails: Callback = scope.props >>= { props =>
      props.routerCtl.set(props.page.toDetails)
    }
