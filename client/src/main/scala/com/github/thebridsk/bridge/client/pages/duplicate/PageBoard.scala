...
/**
  * A component is a view that shows a board of a match.
  *
  * The board will be shown with respect to a perspective.
  * The valid perspectives are:
  * - CompleteBoardView - shows results only if all hands on board have been played
  * - DirectorBoardView - shows all results
  * - TableBoardView - shows results only if both teams on the table and round have played the board.
  *
...
object PageBoard {
  ...
  /**
    ...
    *
    * @see See [[PageBoards$]] for usage information.
    */
  def apply(
      routerCtl: BridgeRouter[DuplicatePage],
      page: BaseBoardViewWithPerspective
