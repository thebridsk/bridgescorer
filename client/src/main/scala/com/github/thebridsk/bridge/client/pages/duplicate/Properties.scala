...
object Properties {
  ...
  val defaultScoreboardWidth: Int = Pixels.getWidthWithBoarder("DefaultScoreboard")
  val defaultNumberOfBoards = 18
  val defaultScoreboardBoardWidth: Int = Pixels.getWidthWithBoarder("DefaultScoreboardBoard")
  val defaultScoreboardPlayersWidth: Int = Pixels.getWidthWithBoarder("DefaultScoreboardPlayers")
  val defaultScoreboardNamesWidthWithoutName: Int = Pixels.getPaddingBorder("DefaultScoreboardNames")
  val defaultScoreboardTitleBoards: Int = Pixels.getWidthWithBoarder("DefaultScoreboardTitleBoards")
