...
object MadeDownPieChart {
  ...
  def description = TagMod(
    ...
    <.br,
    "Green, ",
    PieChart( 15, 1.0::Nil, Some(MadeDownPieChart.ColorMade::Nil), attrs=Some(^.display := "inline-block") ),
    ", is contract made as declarer, red, ",
    PieChart( 15, 1.0::Nil, Some(MadeDownPieChart.ColorDown::Nil), attrs=Some(^.display := "inline-block") ),
    ", is down as declarer.",
    <.br,
    "Dark green, ",
    PieChart( 15, 1.0::Nil, Some(MadeDownPieChart.ColorTookDown::Nil), attrs=Some(^.display := "inline-block") ),
    ", is took down as defender, dark red, ",
    PieChart( 15, 1.0::Nil, Some(MadeDownPieChart.ColorAllowedMade::Nil), attrs=Some(^.display := "inline-block") ),
    ", is allowed made as defender.",
    <.br,
    "Blue, ",
    PieChart( 15, 1.0::Nil, Some(MadeDownPieChart.ColorPassedOut::Nil), attrs=Some(^.display := "inline-block") ),
    ", is passed out hands."
  )
}
