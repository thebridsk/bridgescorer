...
object PageSuggestionInternal {
  ...
  private[duplicate] val SummaryHeader = ScalaComponent
  ...
  private[duplicate] val SummaryRow = ScalaComponent
  ...
  private[duplicate] val NeverPairHeader = ScalaComponent
  ...
  private[duplicate] val NeverPairRow = ScalaComponent
