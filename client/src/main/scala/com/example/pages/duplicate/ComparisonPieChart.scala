...
import com.github.thebridsk.bridge.react.PieChartWithTooltip.IntLegendUtil
import com.github.thebridsk.bridge.react.PieChartWithTooltip
  ...
  def description = {
    TagMod(
      ...
      <.ul(
        ...
        <.li("the team with higher contract, competitive aggressive, was successful.  Example: 5C down 1 vs 4S made"),
        <.li("the team with lower contract, competitive passive, was successful.  Example: 5C* vul down 3 vs 4S made ")
      ),
      <.br,
      "Bad, ",
      ...
      <.ul(
        ...
        <.li("the team with lower contract, competitive passive, failed.  Example: 5C down 1 vs 4S made"),
        <.li("the team with higher contract, competitive aggressive, failed.  Example: 5C* vul down 3 vs 4S made ")
      ),
      <.br,
      "Neutral, ",
