...
class SuggestionPage(
  ...
  def getNumberChecked(implicit patienceConfig: PatienceConfig, pos: Position) = {
    findAllElems[Element]( xpath( """//div[contains(concat(' ', @class, ' '), ' dupDivSuggestionPage ')]/div[3]/ul/li/label/input""") ).
  ...
  private def getCheckboxLabels(implicit patienceConfig: PatienceConfig, pos: Position) = {
    findAllElems[Element]( xpath( """//div[contains(concat(' ', @class, ' '), ' dupDivSuggestionPage ')]/div[3]/ul/li/label""") )
  }
  ...
  private def getNameFieldsElements(implicit patienceConfig: PatienceConfig, pos: Position) = {
    findAllElems[Element]( xpath( """//div[contains(concat(' ', @class, ' '), ' dupDivSuggestionPage ')]/div[4]/ul/li/input""") )
  }
  ...
  def getNeverPairTableNames(implicit patienceConfig: PatienceConfig, pos: Position) = {
    findAllElems[Element]( xpath( """//div[contains(concat(' ', @class, ' '), ' dupDivSuggestionPage ')]/div[5]/table/thead/tr[1]/th""") ).
      drop(1).map( e => e.text )
  }
}
