...
class TestScoring extends AnyFlatSpec with Matchers {
  ...
  import com.github.thebridsk.bridge.data.bridge.RubberBridge.{
    ScoreHand => RubberScore
  }
  import com.github.thebridsk.bridge.data.bridge.DuplicateBridge.{
    ScoreHand => DuplicateScore
  }
  ...
  it should "In duplicate, north plays 3 No Trump not vulernable, Make 3 scores 400" in {
    val hand =
      DuplicateScore("", 3, NoTrump, NotDoubled, North, NotVul, NotVul, Made, 3)
  ...
  it should "In duplicate, east plays 2 spades doubled vulernable, Make 4 scores 400" in {
    val hand =
      DuplicateScore("", 2, Spades, Doubled, East, NotVul, Vul, Made, 4)
  ...
  it should "In duplicate, north plays 1 No Trump redoubled vulernable, Make 7 scores 3160" in {
    val hand =
      DuplicateScore("", 1, NoTrump, Redoubled, North, Vul, NotVul, Made, 7)
  ...
  it should "In duplicate, north plays 7 No Trump redoubled vulernable, Make 7 scores 2980" in {
    val hand =
      DuplicateScore("", 7, NoTrump, Redoubled, North, Vul, NotVul, Made, 7)
  ...
  it should "In duplicate, north plays 7 Club redoubled not vulnerable, Down 1 scores 200" in {
    val hand =
      DuplicateScore("", 7, Clubs, Redoubled, North, NotVul, NotVul, Down, 1)
  ...
  it should "In rubber, east plays 3 No Trump not vulernable, Make 3 scores 100 below for east" in {
    val hand =
      RubberScore("", 3, NoTrump, NotDoubled, East, NotVul, NotVul, Made, 3)
