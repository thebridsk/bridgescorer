...
import com.github.thebridsk.bridge.server.test.pages.duplicate.TableEnterNamesPage
...
import com.github.thebridsk.bridge.server.test.pages.duplicate.PeopleRowIMP
