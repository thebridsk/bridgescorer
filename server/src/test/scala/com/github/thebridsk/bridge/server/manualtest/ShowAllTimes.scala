...
object ShowAllTimes extends Main {
  ...
  val optionFilename: ScallopOption[String] = trailArg[String]("filename", "The match filename", required=true, default=None, hidden=false)
  ...
  val sdf: DateTimeFormatter = DateTimeFormatter.ofPattern("MM/dd/yyyy HH:mm:ss.SSS").withZone( ZoneId.systemDefault() )
