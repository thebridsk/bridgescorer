...
class TestVersionedInstance extends AnyFlatSpec with Matchers {
  ...
  val mc3: MatchChicagoV3 = MatchChicagoV3(
    MatchChicago.id(0),
  ...
  val matchChicagoJsonV1Only
      : VersionedInstanceJson[MatchChicago.Id, MatchChicago] =
    VersionedInstanceJson[MatchChicago.Id, MatchChicago].add[MatchChicagoV1]

  def test[C <: VersionedInstance[
    C,
    C,
    MatchChicago.Id
  ], T <: VersionedInstance[C, T, MatchChicago.Id]](
      v: T,
      good: Boolean,
