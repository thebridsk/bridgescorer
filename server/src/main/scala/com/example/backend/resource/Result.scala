...
object Result {
  ...
  def apply[T]( statusCode: StatusCode, msg: String ): Result[T] = Left((statusCode,RestMessage(msg)))

  def apply[T]( statusCode: StatusCode, msg: RestMessage ): Result[T] = Left((statusCode,msg))
