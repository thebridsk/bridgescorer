...
//      }
  ...
  def xxxgetRounds = {}
  def getRounds( implicit @Parameter(hidden=true) res: Resources[String, Round]) = pathEndOrSingleSlash {
    get {
  ...
  def xxxgetRound = {}
  def getRound( implicit @Parameter(hidden=true) res: Resources[String, Round]) = logRequest("getRound", DebugLevel) { get {
    path( """[a-zA-Z0-9]+""".r ) { id =>
  ...
  def xxxpostRound = {}
  def postRound( implicit @Parameter(hidden=true) res: Resources[String, Round]) = pathEnd {
    post {
  ...
  def xxxputRound = {}
  def putRound( implicit @Parameter(hidden=true) res: Resources[String, Round]) =
    put {
      path( """[a-zA-Z0-9]+""".r ) { id =>
        entity(as[Round]) { round =>
  ...
  def xxxdeleteRound = {}
  def deleteRound( implicit @Parameter(hidden=true) res: Resources[String, Round]) = delete {
    path( """[a-zA-Z0-9]+""".r ) { id =>
