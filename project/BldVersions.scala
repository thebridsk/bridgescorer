...
//  lazy val vScalaJsLibrary = "0.6.13" // http://mvnrepository.com/artifact/org.scala-js/scalajs-library_2.11
  ...
  lazy val vMoment = "2.25.3"          // https://www.npmjs.com/package/moment
...
//  lazy val vJqueryFacade = "1.2"     // https://github.com/jducoeur/jquery-facade               no 2.13 support
  ...
  lazy val vPlayJson = "2.8.1+159-61afe78f+20200516-1155"       // https://github.com/playframework/play-json  from https://github.com/mliarakos/play-json/tree/feature/scalajs-1.0  local build
