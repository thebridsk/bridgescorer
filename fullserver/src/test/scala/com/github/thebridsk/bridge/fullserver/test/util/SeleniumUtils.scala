...
trait SeleniumUtils {
  ...
  def findButton(
    ...
    try {
      find(id(eid)) match {
        case Some(button) =>
          withClue(
            s"${pos.fileName}:${pos.lineNumber} And has a button with id $eid"
          ) { button.tagName mustBe "button" }
          withClue(
            s"${pos.fileName}:${pos.lineNumber} And has a button with id $eid and type $bType"
          ) { button.attribute("type").get mustBe bType }
          text match {
            case Some(t) =>
              withClue(
                s"${pos.fileName}:${pos.lineNumber} And has a button with id $eid and text of $t"
              ) { button.text mustBe t }
              testlog.fine(
                s"${pos.fileName}:${pos.lineNumber} findButton: found button with id $eid type $bType and text $t"
              )
              button
            case None =>
              testlog.fine(
                s"${pos.fileName}:${pos.lineNumber} findButton: found button with id $eid type $bType"
              )
              button
          }
        case None =>
          fail(
            s"${pos.fileName}:${pos.lineNumber} Element with id $eid was not found"
          )
      }
    } catch {
      case x: Throwable =>
        testlog.fine(
          s"${pos.fileName}:${pos.lineNumber} findButton: exception " + x
            .toString(),
          x
        )
        throw x
  ...
  def findButtons(
      ids: String*
  )(implicit webDriver: WebDriver, pos: Position): Map[String, Element] = {
  ...
  /**
    ...
    * @throws TestFailedException if the button was not found or if the specified <code>text</code> or <code>buttontype</code> don't match or if the element tag is not <code>button</code>
    */
  def eventuallyFindButton(eid: String, text: String)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Element = {
  ...
  /**
    ...
    * @throws TestFailedException if all the buttons are not found
    */
  def eventuallyFindButtons(ids: String*)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Map[String, Element] = {
  ...
  /**
    ...
    * @throws TestFailedException if all the buttons are not found or any of the texts don't match
    */
  def eventuallyFindButtons(map: Map[String, String])(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Map[String, Element] = {
  ...
  /**
    ...
    * @throws TestFailedException if the button was not found or if the specified <code>text</code> or <code>buttontype</code> don't match or if the element tag is not <code>button</code>
    */
  def eventuallyFindAndClickButton(id: String, text: Option[String] = None)(
      implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ...
  def eventuallyFindAndClickButton(id: String, text: String)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Unit =
  ...
  def findInput(iname: String, itype: String)(implicit
    ...
    try {
      ...
      withClue("And has an input field with name " + iname) {
        input.getTagName mustBe "input"
      }
      withClue(
        "And has an input field with name " + iname + " and with type " + itype
...
//        x.printStackTrace(System.out)
  ...
  /**
    ...
    */
  def findAllInput(itype: String, iname: String*)(implicit
      webDriver: WebDriver,
      pos: Position
...
//        x.printStackTrace(System.out)
  ...
  /**
    ...
    * @throws TestFailedException if any of the input fields were not found
    */
  def eventuallyFindAllInput(itype: String, iname: String*)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Map[String, TextField] = {
  ...
  /**
    ...
    * @throws TestFailedException if the input was not found or if the specified <code>itype</code> don't match or if the element tag is not <code>input</code>
    */
  def eventuallyFindInput(iname: String, itype: String)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): TextField = {
  ...
  /**
    ...
    * @throws TestFailedException if the input was not found or if the specified <code>itype</code> don't match or if the element tag is not <code>input</code>
    */
  def eventuallyFindElem(id: String)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Element = {
  ...
  /**
    ...
    * @throws TestFailedException if any of the input fields were not found
    */
  def findInputAndSendKeys(iname: String, itype: String, data: String)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Unit = {
  ...
  def findButtonAndClick(eid: String, text: String)(implicit
      webDriver: WebDriver,
      config: PatienceConfig,
      pos: Position
  ): Unit =
  ...
  def findElem(
    ...
    find(id(eid)) match {
      ...
      case None =>
        fail(
          s"${pos.fileName}:${pos.lineNumber} Did not find Element with id $eid"
        )
    }
  }
  ...
  def getElemByXPath(
      xp: String
  )(implicit webDriver: WebDriver, pos: Position): Option[Element] = {
    find(xpath(xp))
  }
  ...
  def findElemByXPath(
    ...
    find(xpath(xp)) match {
      ...
      case None =>
        fail(
          s"""${pos.fileName}:${pos.lineNumber} Did not find Element with xpath query "${xp}""""
        )
    }
  }

  def findElemsByXPath(
      xp: String
  )(implicit webDriver: WebDriver): List[Element] = {
