...
class ChicagoTest
  ...
  it should "play another round of 4 hands" in {
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerS-$playerW"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerE)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"400 $playerN-$playerE"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerW)
      )
  ...
  it should "play third round of 4 hands" in {
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerE-$playerS"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerN)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"400 $playerN-$playerW"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerE)
      )
  ...
  it should "play fourth round of 4 hands" in {
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"620 $playerW-$playerS"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerS)
      )
    ...
    val sp4 = hp4
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"130 $playerW-$playerS"),
        nsVul = Vul,
        ewVul = Vul,
        dealer = Some(playerW)
      )
  ...
  def findNorthInputList: List[Element] =
