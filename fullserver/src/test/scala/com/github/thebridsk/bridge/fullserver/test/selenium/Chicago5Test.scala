...
class Chicago5Test
  ...
  it should "play a round of 4 hands" in {
    ...
    val sp = hp
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerN-$playerS"),
        nsVul = NotVul,
        ewVul = NotVul,
        dealer = Some(playerN)
      )
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"620 $playerE-$playerW"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerE)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"600 $playerN-$playerS"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerS)
      )
    ...
    val sp4 = hp4
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"130 $playerE-$playerW"),
        nsVul = Vul,
        ewVul = Vul,
        dealer = Some(playerW)
      )
  ...
  it should "allow setting the partner and dealer for second round" in {
    ...
    withClue(
      s"Testing pairing 0: $pairing1, $playerN-$playerW $playerO-$playerS"
    ) {
    ...
    withClue(
      s"Testing pairing 1: $pairing2, $playerN-$playerO $playerS-$playerW"
    ) {
  ...
  it should "play another round of 4 hands" in {
    ...
    val sp = hp
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerN-$playerO"),
        nsVul = NotVul,
        ewVul = NotVul,
        dealer = Some(playerN)
      )
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"620 $playerS-$playerW"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerS)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"600 $playerN-$playerO"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerO)
      )
    ...
    val sp4 = hp4
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"130 $playerS-$playerW"),
        nsVul = Vul,
        ewVul = Vul,
        dealer = Some(playerW)
      )
  ...
  it should "play third round of 4 hands" in {
    ...
    val sp = hp
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerO-$playerE"),
        nsVul = NotVul,
        ewVul = NotVul,
        dealer = Some(playerN)
      )
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerN-$playerW"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerE)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"400 $playerO-$playerE"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerW)
      )
    ...
    val sp4 = hp4
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"130 $playerN-$playerW"),
        nsVul = Vul,
        ewVul = Vul,
        dealer = Some(playerO)
      )
  ...
  it should "play fourth round of 4 hands" in {
    ...
    val sp = hp
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerN-$playerE"),
        nsVul = NotVul,
        ewVul = NotVul,
        dealer = Some(playerN)
      )
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"620 $playerO-$playerS"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerO)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"600 $playerN-$playerE"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerE)
      )
    ...
    val sp4 = hp4
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"130 $playerO-$playerS"),
        nsVul = Vul,
        ewVul = Vul,
        dealer = Some(playerS)
      )
  ...
  it should "play fifth round of 4 hands" in {
    ...
    val sp = hp
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"420 $playerO-$playerW"),
        nsVul = NotVul,
        ewVul = NotVul,
        dealer = Some(playerO)
      )
    ...
    val sp2 = hp2
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"620 $playerE-$playerS"),
        nsVul = NotVul,
        ewVul = Vul,
        dealer = Some(playerE)
      )
    ...
    val sp3 = hp3
      .enterHand(
        ...
        Made,
        5,
        score = Some(s"600 $playerO-$playerW"),
        nsVul = Vul,
        ewVul = NotVul,
        dealer = Some(playerW)
      )
    ...
    val sp4 = hp4
      .enterHand(
        ...
        Made,
        4,
        score = Some(s"130 $playerE-$playerS"),
        nsVul = Vul,
        ewVul = Vul,
        dealer = Some(playerS)
      )
