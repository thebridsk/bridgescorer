...
object Duplicate5TestPages {
  ...
  val peopleResult2 = List(
                        ...
                        PeopleRow(team2.one,"0.00%","0.00%","50.00%","0.00","-16.0","0","0.00","0","0.00","2","1","1","0","50.00% (18.0/36)","16","32"),
                        PeopleRow(team1.one,"50.00%","25.00%","37.50%","100.00","14.0","0","0.00","1","0.50","2","1","1","0","37.50% (13.5/36)","12","32"),
                        PeopleRow(team4.one,"50.00%","50.00%","59.38%","16.67","-11.0","1","1.00","0","0.00","2","1","1","0","59.38% (21.4/36)","19","32"),
                        PeopleRow(team4.two,"50.00%","50.00%","59.38%","50.00","-1.0","1","1.00","0","0.00","2","1","1","0","59.38% (21.4/36)","19","32"),
                        PeopleRow(team1.two,"50.00%","25.00%","37.50%","100.00","14.0","0","0.00","1","0.50","2","1","1","0","37.50% (13.5/36)","12","32"),
                        PeopleRow(team2.two,"50.00%","25.00%","50.00%","100.00","14.0","0","0.00","1","0.50","2","1","1","0","50.00% (18.0/36)","16","32"),
  ...
  val peopleResultMP2 = List(
                        ...
                        PeopleRowMP(team2.one,"0.00%","0.00%","43.75%","0","0.00","2","0","50.00% (18.0/36)","28","64"),
                        PeopleRowMP(team1.one,"0.00%","0.00%","46.88%","0","0.00","2","0","56.25% (20.3/36)","30","64"),
                        PeopleRowMP(team4.one,"50.00%","50.00%","53.13%","1","1.00","2","0","59.38% (21.4/36)","34","64"),
                        PeopleRowMP(team4.two,"50.00%","50.00%","54.69%","1","1.00","2","0","59.38% (21.4/36)","35","64"),
                        PeopleRowMP(team1.two,"50.00%","50.00%","48.44%","1","1.00","2","0","59.38% (21.4/36)","31","64"),
  ...
  val peopleResult = List(
                        ...
                        PeopleRow(team5.two,"0.00%","0.00%","56.25%","0.00","0.0","0","0.00","0","0.00","1","1","0","0","56.25% (20.3/36)","18","32"),
                        PeopleRow(team2.one,"0.00%","0.00%","50.00%","0.00","0.0","0","0.00","0","0.00","1","1","0","0","50.00% (18.0/36)","16","32"),
                        PeopleRow(team2.two,"0.00%","0.00%","50.00%","0.00","0.0","0","0.00","0","0.00","1","1","0","0","50.00% (18.0/36)","16","32"),
                        PeopleRow(team3.one,"0.00%","0.00%","46.88%","0.00","0.0","0","0.00","0","0.00","1","1","0","0","46.88% (16.9/36)","15","32"),
                        PeopleRow(team3.two,"0.00%","0.00%","46.88%","0.00","0.0","0","0.00","0","0.00","1","1","0","0","46.88% (16.9/36)","15","32"),
                        PeopleRow(team1.one,"0.00%","0.00%","37.50%","0.00","0.0","0","0.00","0","0.00","1","1","0","0","37.50% (13.5/36)","12","32"),
  ...
  val peopleResultMP = List(
                        ...
                        PeopleRowMP(team5.two,"0.00%","0.00%","56.25%","0","0.00","1","0","56.25% (20.3/36)","18","32"),
                        PeopleRowMP(team2.one,"0.00%","0.00%","50.00%","0","0.00","1","0","50.00% (18.0/36)","16","32"),
                        PeopleRowMP(team2.two,"0.00%","0.00%","50.00%","0","0.00","1","0","50.00% (18.0/36)","16","32"),
                        PeopleRowMP(team3.one,"0.00%","0.00%","46.88%","0","0.00","1","0","46.88% (16.9/36)","15","32"),
                        PeopleRowMP(team3.two,"0.00%","0.00%","46.88%","0","0.00","1","0","46.88% (16.9/36)","15","32"),
