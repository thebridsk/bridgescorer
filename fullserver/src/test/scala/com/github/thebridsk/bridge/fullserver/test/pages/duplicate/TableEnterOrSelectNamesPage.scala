...
class TableEnterOrSelectNamesPage(
    dupid: String,
    tableid: String,
    roundid: String,
    ...
    with ErrorMsgDiv[TableEnterOrSelectNamesPage] {
...
//      b.click
  ...
  def selectNamesAndClickButton(
    ...
    val inputs1 = List("Player_N", "Player_S", "Player_E", "Player_W")
      .map(p => {
    ...
    inputs1.foreach { entry =>
      {
        ...
        name match {
          case "Player_N" =>
            swap =
              swap || (North != scorekeeper && North != partner && t != nsPlayer1)
          case "Player_S" =>
            swap =
              swap || (South != scorekeeper && South != partner && t != nsPlayer2)
          case "Player_E" =>
            swap =
              swap || (East != scorekeeper && East != partner && t != ewPlayer1)
          case "Player_W" =>
            swap =
              swap || (West != scorekeeper && West != partner && t != ewPlayer2)
          case x => log.fine("Found an input field with name " + x)
        }
      }
    }
