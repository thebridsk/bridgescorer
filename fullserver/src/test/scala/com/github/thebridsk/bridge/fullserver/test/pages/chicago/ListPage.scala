...
object ListPage {
  ...
  val importSuccessPattern: Regex = """import chicago (C\d+) from ([^,]+), new ID (C\d+)""".r
...
class ListPage( importId: Option[String] = None )( implicit val webDriver: WebDriver, pageCreated: SourcePosition ) extends Page[ListPage] with Popup[ListPage] with PagesAssertions {
  ...
  def getTable(implicit patienceConfig: PatienceConfig, pos: Position): ListTable = {
    val r = ListTable()
  ...
  /**
    ...
    * @param pos
    */
  def checkPlayers( row: Int, players: String* )(implicit patienceConfig: PatienceConfig, pos: Position): Assertion = {
  ...
  /**
    ...
    * @param pos
    */
  def clickDelete( row: Int )(implicit patienceConfig: PatienceConfig, pos: Position): ListPage = {
...
object ListTable {
  def apply()( implicit webDriver: WebDriver, patienceConfig: PatienceConfig, pos: Position ): ListTable = {
