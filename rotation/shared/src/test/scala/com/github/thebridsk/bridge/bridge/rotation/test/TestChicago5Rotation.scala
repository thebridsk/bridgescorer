...
class TestChicago5Rotation extends AnyFlatSpec with Matchers {
  ...
  it should "swap left and partner of north" in {
    val result =
      Table(north = "A", south = "B", east = "C", west = "D", sittingOut = "E")
  ...
  it should "swap left and partner of south" in {
    val result =
      Table(north = "D", south = "C", east = "B", west = "A", sittingOut = "E")
  ...
  it should "swap left and partner of east" in {
    val result =
      Table(north = "A", south = "D", east = "B", west = "C", sittingOut = "E")
  ...
  it should "swap left and partner of west" in {
    val result =
      Table(north = "B", south = "C", east = "A", west = "D", sittingOut = "E")
  ...
  it should "swap left and partner of and rotate north" in {
    val result =
      Table(north = "E", south = "B", east = "C", west = "D", sittingOut = "A")
  ...
  it should "swap left and partner of and rotate south" in {
    val result =
      Table(north = "D", south = "E", east = "B", west = "A", sittingOut = "C")
  ...
  it should "swap left and partner of and rotate east" in {
    val result =
      Table(north = "A", south = "D", east = "E", west = "C", sittingOut = "B")
  ...
  it should "swap left and partner of and rotate west" in {
    val result =
      Table(north = "B", south = "C", east = "A", west = "E", sittingOut = "D")
  ...
  it should "swap right and partner of and rotate north" in {
    val result =
      Table(north = "E", south = "D", east = "B", west = "C", sittingOut = "A")
  ...
  it should "swap right and partner of and rotate south" in {
    val result =
      Table(north = "B", south = "E", east = "A", west = "D", sittingOut = "C")
  ...
  it should "swap right and partner of and rotate east" in {
    val result =
      Table(north = "D", south = "C", east = "E", west = "A", sittingOut = "B")
  ...
  it should "swap right and partner of and rotate west" in {
    val result =
      Table(north = "A", south = "B", east = "C", west = "E", sittingOut = "D")
  ...
  it should "rotate clockwise" in {
    val resultN =
      Table(north = "E", south = "B", east = "D", west = "C", sittingOut = "A")
    defaultTable.rotateClockwise(North) mustBe resultN
    val resultS =
      Table(north = "D", south = "E", east = "A", west = "B", sittingOut = "C")
    defaultTable.rotateClockwise(South) mustBe resultS
    val resultE =
      Table(north = "D", south = "A", east = "E", west = "C", sittingOut = "B")
    defaultTable.rotateClockwise(East) mustBe resultE
    val resultW =
      Table(north = "C", south = "B", east = "A", west = "E", sittingOut = "D")
    defaultTable.rotateClockwise(West) mustBe resultW
  }
  it should "rotate counterclockwise" in {
    val resultN =
      Table(north = "E", south = "D", east = "C", west = "B", sittingOut = "A")
    defaultTable.rotateCounterClockwise(North) mustBe resultN
    val resultS =
      Table(north = "B", south = "E", east = "D", west = "A", sittingOut = "C")
    defaultTable.rotateCounterClockwise(South) mustBe resultS
    val resultE =
      Table(north = "C", south = "D", east = "E", west = "A", sittingOut = "B")
    defaultTable.rotateCounterClockwise(East) mustBe resultE
    val resultW =
      Table(north = "B", south = "A", east = "C", west = "E", sittingOut = "D")
    defaultTable.rotateCounterClockwise(West) mustBe resultW
  }

  it should "rotate three players" in {
    defaultTable
      .rotateClockwise(North)
      .rotateCounterClockwise(North) mustBe defaultTable
    defaultTable
      .rotateClockwise(South)
      .rotateCounterClockwise(South) mustBe defaultTable
    defaultTable
      .rotateClockwise(East)
      .rotateCounterClockwise(East) mustBe defaultTable
    defaultTable
      .rotateClockwise(West)
      .rotateCounterClockwise(West) mustBe defaultTable
  }
...
//  }
  ...
  it should "play 15 rounds with playComplete owesn" in {
    val s =
      Table(north = "1", south = "2", east = "3", west = "4", sittingOut = "5")
    ...
    (result zip players.tail ::: players ::: players ::: players).zipWithIndex
      .foreach(e => {
        val ((t, p), i) = e
  ...
  it should "play 10 rounds with playComplete maneuverLeft and random" in {
    ...
    val failed = (for (round1 <- players.tail.permutations;
      ...
      if (round1.last != round2.head) {
        try {
          count = count + 1
          val maneuvers = (round1 ::: round2).map(
            Chicago5Rotation.maneuverLeftStillOthersSwap(_) _
          )
  ...
  it should "work in 4 of the player rotations" in {
    ...
    if (failed.size != 0) {
      ...
      println(failed.mkString("\n"))
      println()
      if (perms.size - failed.size != 4)
        fail("Did not work with exactly 4 permutations")
    }
  }
  ...
  def checkResult(result: List[Table], expectedCount: Int): Unit = {
    ...
    if (!r.isEmpty) {
      println(
        s"Did not get $expectedCount occurences of all pairs\n" + r
          .mkString("\n")
      )
