...
//        - type: object
  ...
  @ArraySchema(
    ...
    arraySchema = new Schema(name = "Array", description = "array of any value")
  )
  class VJsArray
  ...
  case class GraphQLRequest(
      ...
      @Schema(
        ...
        implementation = classOf[VJsObjectReq],
        required = false
      )
...
// {"error":"Syntax error while parsing GraphQL query. Invalid input 'x', expected OperationDefinition, FragmentDefinition or TypeSystemDefinition (line 1, column 1):\nxxx\n^"}
  ...
  case class ErrorMessage(
      ...
      @ArraySchema(
        ...
        arraySchema = new Schema(required = false)
      )
  ...
  case class GraphQLResponse(
      @Schema(
        ...
        implementation = classOf[AnyValueData],
        required = false
      )
      data: Option[JsValue],
      @Schema(
      ...
      @ArraySchema(
        ...
        uniqueItems = false,
        arraySchema =
          new Schema(description = "Error message(s)", required = false)
      )
      errors: Option[List[ErrorMessage]],
      @Schema(
        description = "Extensions",
        implementation = classOf[AnyValueExt],
        required = false
      )
