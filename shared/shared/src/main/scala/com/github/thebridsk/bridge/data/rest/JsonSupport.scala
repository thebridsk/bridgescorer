...
trait JsonSupport {
  ...
  implicit val idMatchRubberKeyReads: KeyReads[Id[IdMatchRubber]] =
    MatchRubber.idKeyReads
  implicit val idMatchRubberKeyWrites: KeyWrites[Id[IdMatchRubber]] =
    MatchRubber.idKeyWrites
  implicit val idMatchChicagoKeyReads: KeyReads[Id[IdMatchChicago]] =
    MatchChicago.idKeyReads
  implicit val idMatchChicagoKeyWrites: KeyWrites[Id[IdMatchChicago]] =
    MatchChicago.idKeyWrites
  implicit val idDuplicateMatchKeyReads: KeyReads[Id[IdDuplicateSummary]] =
    DuplicateSummary.idKeyReads
  implicit val idDuplicateMatchKeyWrites: KeyWrites[Id[IdDuplicateSummary]] =
    DuplicateSummary.idKeyWrites
  implicit val idMatchDuplicateKeyReads: KeyReads[Id[IdMatchDuplicate]] =
  ...
  implicit val idBoardSetKeyReads: KeyReads[Id[IdBoardSet]] =
    BoardSet.idKeyReads
  implicit val idBoardSetKeyWrites: KeyWrites[Id[IdBoardSet]] =
    BoardSet.idKeyWrites
  implicit val idMovementKeyReads: KeyReads[Id[IdMovement]] =
    Movement.idKeyReads
  ...
  implicit val idMatchDuplicateResultKeyWrites
      : KeyWrites[Id[IdMatchDuplicateResult]] = MatchDuplicateResult.idKeyWrites

  implicit val idMatchRubberFormat: Format[Id[IdMatchRubber]] =
    MatchRubber.jsonFormat
  implicit val idMatchChicagoFormat: Format[Id[IdMatchChicago]] =
    MatchChicago.jsonFormat
  implicit val idDuplicateMatchFormat: Format[Id[IdDuplicateSummary]] =
...
//  implicit val duplicateHandFormat = Json.format[DuplicateHand]
  implicit val duplicateHandV1Format: OFormat[DuplicateHandV1] =
...
//  implicit val duplicateFormat = Json.format[MatchDuplicate]
  ...
  implicit val duplicateV2Format: OFormat[MatchDuplicateV2] =
  ...
  implicit val duplicateSummaryEntryFormat: OFormat[DuplicateSummaryEntry] =
    Json.format[DuplicateSummaryEntry]
...
//  implicit val duplicateResultFormat = Json.format[MatchDuplicateResult]
  ...
  implicit val duplicateResultV2Format: OFormat[MatchDuplicateResultV2] =
    Json.format[MatchDuplicateResultV2]
  implicit val chicagoBestMatchFormat: OFormat[ChicagoBestMatch] =
    Json.format[ChicagoBestMatch]
  implicit val chicagoFormat: OFormat[MatchChicago] = Json.format[MatchChicago]
  implicit val chicagov2Format: OFormat[MatchChicagoV2] =
    Json.format[MatchChicagoV2]
  implicit val chicagov1Format: OFormat[MatchChicagoV1] =
    Json.format[MatchChicagoV1]
  implicit val rubberBestMatchFormat: OFormat[RubberBestMatch] =
    Json.format[RubberBestMatch]
  ...
  implicit val serverVersionFormat: OFormat[ServerVersion] =
    Json.format[ServerVersion]
...
//  implicit val boarsetsAndMovementsFormat = Json.format[BoardSetsAndMovementsV1]
  ...
  implicit val duplicateNeverPairFormat: OFormat[NeverPair] =
    Json.format[NeverPair]
  implicit val duplicateSuggestionsFormat: OFormat[DuplicateSuggestions] =
    Json.format[DuplicateSuggestions]
  implicit val duplicatePlayerPlaceFormat: OFormat[PlayerPlace] =
    Json.format[PlayerPlace]
  implicit val duplicatePlayerPlacesFormat: OFormat[PlayerPlaces] =
    Json.format[PlayerPlaces]

  implicit val counterStatFormat: OFormat[CounterStat] =
    Json.format[CounterStat]
  implicit val contractStatFormat: OFormat[ContractStat] =
    Json.format[ContractStat]
  implicit val contractStatsFormat: OFormat[ContractStats] =
    Json.format[ContractStats]
  implicit val playerStatFormat: OFormat[PlayerStat] = Json.format[PlayerStat]
  implicit val playerStatsFormat: OFormat[PlayerStats] =
    Json.format[PlayerStats]
  implicit val playerComparisonStatFormat: OFormat[PlayerComparisonStat] =
    Json.format[PlayerComparisonStat]
  implicit val playerComparisonStatsFormat: OFormat[PlayerComparisonStats] =
    Json.format[PlayerComparisonStats]
  implicit val playerOpponentStatFormat: OFormat[PlayerOpponentStat] =
    Json.format[PlayerOpponentStat]
  implicit val playerOpponentsStatFormat: OFormat[PlayerOpponentsStat] =
    Json.format[PlayerOpponentsStat]
  implicit val playersOpponentsStatsFormat: OFormat[PlayersOpponentsStats] =
    Json.format[PlayersOpponentsStats]
  implicit val duplicateStatsFormat: OFormat[DuplicateStats] =
    Json.format[DuplicateStats]

  implicit val importStoreData: OFormat[ImportStoreData] =
    Json.format[ImportStoreData]
...
object JsonSupport extends JsonSupport {
  ...
  implicit class FromJsonSupportWrapper(private val json: String)
      extends AnyVal {
