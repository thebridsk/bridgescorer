...
package object bridge {
  ...
  val contractSuits: List[ContractSuit] = NoTrump :: Spades :: Hearts :: Diamonds :: Clubs :: Nil

  val contractTricks: List[ContractTricks] = ContractTricks(0) :: ContractTricks(1) :: ContractTricks(
    2
  ) :: ContractTricks(3) ::
  ...
  val contractDoubling: List[ContractDoubled] = NotDoubled :: Doubled :: Redoubled :: Nil
