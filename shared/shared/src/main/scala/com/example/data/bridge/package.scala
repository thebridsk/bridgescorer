...
package object bridge {
  ...
  val contractTricks = ContractTricks(0)::ContractTricks(1)::ContractTricks(2)::ContractTricks(3)::
                       ContractTricks(4)::ContractTricks(5)::ContractTricks(6)::ContractTricks(7)::Nil
