...
case class BoardSetsAndMovementsV1(
    @ArraySchema(
        ...
        arraySchema = new Schema( description = "All the boardsets known to the server.", required=true)
    )
    ...
    @ArraySchema(
        ...
        arraySchema = new Schema( description = "All the movements known to the server.", required=true)
    )
