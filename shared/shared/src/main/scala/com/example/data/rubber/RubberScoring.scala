...
class GameScoring( val hands: List[RubberHand],
                   val nsVul: Boolean,
                   val ewVul: Boolean ) {
  ...
  private def calculate() = {
    val sh = hands.map { h => ScoreHand(h) }
    val (nsA,nsB,ewA,ewB) = sh.map {
      h => h.getScores()
    }.foldLeft((0,0,0,0))( (a,v) => (a._1+v._1,a._2+v._2,a._3+v._3,a._4+v._4) )
    (nsA,nsB,ewA,ewB,sh)
  }
  ...
  def scores: (List[Int],List[Int],List[Int],List[Int]) = {
    ...
    val (na,nb,ea,eb) =
    scoredHands.foldLeft( (Nil: List[Int],Nil: List[Int],Nil: List[Int],Nil: List[Int]) )( (a,v) => {
      val sc = v.getScores()
      (
...
class RubberScoring( val rubber: MatchRubber ) {
  ...
  val (nsBelow, ewBelow, nsAbove, ewAbove) = {
    games.map { g => (g.nsBelow, g.ewBelow, g.nsAbove, g.ewAbove) }.foldLeft((0,0,0,0))( (a,v) => (a._1+v._1,a._2+v._2,a._3+v._3,a._4+v._4) )
  }
   ...
   */
  def totals = {
    val x = games.foldLeft((Nil: List[Int], Nil: List[List[Int]], Nil: List[Int], Nil: List[List[Int]]))((a,gs) => {
      val r = gs.scores
      ( r._1:::a._1,
        r._2::a._2,
        r._3:::a._3,
   ...
   */
  def setFirstDealer( pos: String ) = new RubberScoring( rubber.setFirstDealer(pos) )
