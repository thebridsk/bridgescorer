    ...
    if (hand.contractDoubled == NotDoubled.doubled) None
      ...
      if (hand.contractTricks == 7) ContractTypeGrandSlam
        ...
        hand.contractSuit match {
          case "N" =>
            if (hand.contractTricks>=3) ContractTypeGame else if (hand.contractTricks==2) ContractTypeDoubledToGame else ContractTypePartial
          case "S" | "H" =>
            if (hand.contractTricks>=4) ContractTypeGame else if (hand.contractTricks>=2) ContractTypeDoubledToGame else ContractTypePartial
          case "D" | "C" =>
            if (hand.contractTricks>=5) ContractTypeGame else if (hand.contractTricks>=3) ContractTypeDoubledToGame else ContractTypePartial
          case _ =>
            ContractTypePartial
        }
      }
