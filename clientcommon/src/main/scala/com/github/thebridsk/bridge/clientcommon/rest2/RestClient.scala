...
/**
  ...
  */
class RestClient[R, I](
    val resourceURIfragment: String,
  ...
  def resourceURI: String =
    parentClient match {
      case Some(parent) =>
        s"${parent.getURIfromString(parentInstance.get)}/$resourceURIfragment"
  ...
  implicit def ajaxToRestResult(
      ajaxResult: AjaxResult[WrapperXMLHttpRequest]
  ): RestResult[R] = {
    RestResult.ajaxToRestResult(ajaxResult)
  }

  implicit def ajaxToRestResultUnit(
      ajaxResult: AjaxResult[WrapperXMLHttpRequest]
  ): RestResult[Unit] = {
    RestResult.ajaxToRestResult(ajaxResult)
  }

  implicit def ajaxToRestResultArray(
      ajaxResult: AjaxResult[WrapperXMLHttpRequest]
  ): RestResultArray[R] = {
...
object RestClient {
  implicit class RestMessages(private val req: WrapperXMLHttpRequest)
      extends AnyVal {
