...
object Tooltip {
  ...
  def apply(
    ...
    component(
      Props(data, Some(tooltipbody), None)
  ...
  def apply(
    ...
    component(
      Props(data, Some(tooltipbody), Some(tooltiptitle))
    ) // scalafix:ok ExplicitResultTypes; ReactComponent
  ...
  def apply(
    ...
    component(
      Props(data, Some(tooltipbody), tooltiptitle)
    ) // scalafix:ok ExplicitResultTypes; ReactComponent
  ...
  def apply(
    ...
    component(
      Props(data, tooltipbody, tooltiptitle)
    ) // scalafix:ok ExplicitResultTypes; ReactComponent
